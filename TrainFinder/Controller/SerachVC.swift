...
class SerachVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        requestData()
        setText()
        self.navigationItem.title = "查詢時刻表"
    }
...
//                                        width: fullScreenSize.width * 0.9, height: fullScreenSize.height * 0.35))
        pickBgView = UIView(frame: CGRect(
                                x: fullScreenSize.width * 0.05, y: fullScreenSize.height * 0.3,
                                width: fullScreenSize.width * 0.9, height: fullScreenSize.height * 0.35))
        pickBgView.backgroundColor = #colorLiteral(red: 0.9411764741, green: 0.4980392158, blue: 0.3529411852, alpha: 1)
        stationPicker.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0)
        ...
        pickImageView.image = UIImage(named: "bg")
        // 加入到畫面
        self.view.addSubview(pickBgView)
        self.pickBgView.addSubview(pickImageView)
    ...
    @objc func dateTarget(textField: UITextField) {
        ...
        dateBgView.backgroundColor = #colorLiteral(red: 0.4620226622, green: 0.8382837176, blue: 1, alpha: 1)
        datePicker.tintColor = #colorLiteral(red: 0.5725490451, green: 0, blue: 0.2313725501, alpha: 1)
...
extension SerachVC: UIPickerViewDelegate, UIPickerViewDataSource {
...
extension SerachVC: UITextFieldDelegate {
